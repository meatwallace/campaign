...
export type GetCurrentUserQuery = { __typename?: 'Query', getCurrentUser: { __typename?: 'User', id: string, name: string } };
...
export type GetWorldsQuery = { __typename?: 'Query', getWorlds: Array<{ __typename?: 'World', id: string, name: string }> };
